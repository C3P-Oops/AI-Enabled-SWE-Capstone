...
const jobsData = [
    { title: 'Job Title', department: 'Product', status: 'Open', applicants: 85, actions: ['View', 'Edit'] },
  ...
  return (
    <div className="bg-slate-100 min-h-screen flex items-center justify-center p-4 font-sans">
      <div className="w-full max-w-7xl bg-white rounded-2xl shadow-lg flex min-h-[800px]">
        {/* Sidebar */}
        <aside className="w-24 flex-shrink-0 bg-slate-50 rounded-l-2xl flex flex-col items-center py-6">
          <nav className="flex flex-col items-center space-y-2">
            <a href="#" className="flex flex-col items-center text-slate-500 hover:text-blue-600 p-3 rounded-lg transition-colors">
              <UsersIcon />
            ...
            <a href="#" className="flex flex-col items-center bg-blue-500 text-white p-3 rounded-lg shadow-md">
              <BriefcaseIcon />
              <span className="text-xs mt-1">Jobs</span>
            </a>
            <a href="#" className="flex flex-col items-center text-slate-500 hover:text-blue-600 p-3 rounded-lg transition-colors">
            ...
            <a href="#" className="flex flex-col items-center text-slate-500 hover:text-blue-600 p-3 rounded-lg transition-colors">
              <span className="text-xs mt-1 h-6 flex items-center">Reports</span>
            </a>
          </nav>
        </aside>
        ...
        <main className="flex-1 p-8">
          ...
          <header className="flex justify-between items-center pb-6">
            <h1 className="text-3xl font-bold text-slate-800">SmartHire ATS</h1>
          ...
          <div className="flex justify-between items-center my-6">
            ...
            <button className="flex items-center bg-blue-500 text-white font-semibold px-4 py-2 rounded-lg shadow-sm hover:bg-blue-600 transition-colors">
